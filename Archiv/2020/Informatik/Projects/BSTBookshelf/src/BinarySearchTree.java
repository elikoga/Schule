...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
    ...
    public void insert(ContentType pContent) {
        if (pContent != null) {
            BinarySearchTree<ContentType> insp = this;
            while (!insp.isEmpty()) {
                if (pContent.equals(insp.node)) {
                    return;
                }
                insp = pContent.isLess(insp.node.content) ? insp.node.left : insp.node.right;
            }
            insp.node = new BSTNode<>(pContent);
        }
     ...
     *
     * @return den linken Teilbaum (Objekt vom Typ
     * BinarySearchTree<ContentType>) bzw. null, wenn der Suchbaum leer ist
     *
     */
     ...
     *
     * @return das Inhaltsobjekt vom Typ ContentType bzw. null, wenn der
     ...
     * Wenn er leer ist, wird null zurueckgegeben.
     *
     * @return den rechten Teilbaum (Objekt vom Typ
     * BinarySearchTree<ContentType>) bzw. null, wenn der aktuelle Suchbaum leer
     * ist
     *
     */
    ...
    /**
     * Falls ein bezueglich der verwendeten Vergleichsmethode mit pContent
     ...
     * @return das gefundene Objekt vom Typ ContentType, bei erfolgloser Suche
     * null
     *
     */
    ...
    /**
     * Die Methode liefert denjenigen Baum, dessen linker Nachfolger keinen
     * linken Nachfolger mehr hat. Es ist also spaeter moeglich, in einem Baum
     * im rechten Nachfolger den Vorgaenger des linkesten Nachfolgers zu finden.
     *
     */
